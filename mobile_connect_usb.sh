...
# It seeems online is reported directly on Private Network, use sleep
#echo "but first sleep 10s.."
#sleep 10
...
echo 'Add route to waraps ('$warapsip') stream via '$iface
route add -host $warapsip $iface
